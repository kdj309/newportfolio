...
export default function Projectitem({ projectimg, projectTitle, projectLink, projectDescription, gitrepo }) {
        ...
        <Tilt className="MaincardItem">
            <div className="card">
                ...
                <div className='btn-container'>
                    <a href={projectLink} className='btn' id='Viewbtn'>View <AiFillEye /></a>
