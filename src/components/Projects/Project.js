...
export default function Project() {
    const projects = [
        ...
        {
            projectName: "Recipe Wikipedia",
            projectDesc: `Recipe finder site where users can search, sort, filter different kinds of
            recipe based on tags, etc`,
            projectLink: 'https://indianfoodie.netlify.app/',
            gitrepo: 'https://github.com/kdj309/recipe_web_app',
            alterstyle: false,
            projectImg: projimg4
        },
    ]
